  ...
  return (
    pData != undefined && (
        <div className="px-4 my-3 md:my-[3vh]">
          ...
          {uniqueCategories.length>0 && <div className="flex xl:mt-[2vw] xl:mb-[3vw]  mt-4 mb-6 w-fit gap-[0.5vw] items-center">
          ...
          <InfiniteScroll
            className="w-[100%] flex justify-center flex-wrap gap-[2vw] md:gap-[1.2vw] md:justify-start"
