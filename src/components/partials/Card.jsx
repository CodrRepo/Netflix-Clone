  ...
  return  (
    <Link to={`/${dataType}/details/${element.id}`} className='w-[13vw] flex-shrink-0 '>
      <div className='h-[15vw] rounded-md  overflow-hidden'>
        <img className='h-full w-full object-cover object-center' src={`https://image.tmdb.org/t/p/w500/${element.backdrop_path || element.poster_path || element.profile_path}`} alt="" />
      </div>
