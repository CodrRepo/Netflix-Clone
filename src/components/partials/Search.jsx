...
const Search = () => {
  ...
  return (
    <div className=" relative z-40 search-container flex justify-center gap-3 items-center mt-5">
          <div className="search items-center flex px-2 rounded-md bg-[#222125]">
          <span className="text-white text-xl">
            ...
            <input
              ...
              value={query}
              className="outline-none border-none w-[30vw] rounded-md bg-[#222125] px-4 py-2 text-white placeholder-zinc-500"
              type="text"
              name="query"
              id="search"
              autoComplete='off'
          ...
          <div
            className={`bg-black mt-2 overflow-auto absolute top-[100%] left-50% w-[35vw] max-h-[10rem]`}
          >
            <ul className={`text-white flex flex-col `}>
                {searchData && searchData.map((element, index)=><li key={index} className="hover:bg-[#101013] w-full py-2 px-1 pl-4 flex items-center gap-3">
